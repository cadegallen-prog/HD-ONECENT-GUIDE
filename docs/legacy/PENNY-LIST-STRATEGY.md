# Penny List Strategy: The "Community-Powered" Engine (ARCHIVED)

**Archived on:** 2026-01-26

This is an archived copy of the original Penny List Strategy documentation that described a Google Form → Google Sheet intake pipeline. The site migrated to a Supabase-backed "Report a Find" flow in Dec 2025; the active documentation and operational procedures live in `docs/CROWDSOURCE-SYSTEM.md`.
