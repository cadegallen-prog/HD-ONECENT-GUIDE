...
- [dead-link-safe-paths](./dead-link-safe-paths.md) — **When to use:** Founder-facing replies need file, proof, or report references that are actually usable in chat clients where local markdown links render dead.
