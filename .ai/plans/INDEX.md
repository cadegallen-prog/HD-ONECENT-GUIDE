...
| ---------------------------------------------- | -------------------------- | ----------------- | ------------ | ----------------------------------------------------------------------------- |
| `.ai/plans/sitewide-monetization-readiness.md` | Planning                   | P0 (Monetization) | 2026-02-08   | Sitewide route policy + inventory lifecycle + Monumetric handoff architecture |
