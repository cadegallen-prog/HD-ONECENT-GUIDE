...
**Last updated:** Mar 3, 2026 (`S2` homepage proof front door verified locally)
...
**Founder override (active):** Site recovery is the current product-priority program. Start from `.ai/impl/site-recovery-program.md`. `S2 - Homepage Proof Front Door` is complete; the immediate next implementation slice is `S3 - Guide Core Rebuild`.
