...
| -------------------- | ----------- | ----------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `INC-ADSENSE-001`    | 2026-02-02  | 2026-02-13  | `OPEN-REMEDIATION-DEPLOY-PENDING` | `monumental/email-samanthaMelaney_publisher_sucesss_associate.pdf` (OCR evidence), `.ai/evidence/adsense/2026-02-13-monumetric-email-ocr-extract.md`, `.ai/evidence/adsense/2026-02-13-route-snapshot.json`, `.ai/evidence/adsense/2026-02-13-sku-route-snapshot.json`, `.ai/evidence/adsense/2026-02-13-policy-route-audit.md`, `.ai/evidence/adsense/2026-02-12-needs-attention-policy-violations.md`, https://support.google.com/adsense/answer/10502938?hl=en | First denial: Low Value Content (`2026-02-02`). Re-applied (`2026-02-03`). Second denial state (`2026-02-12`): "We found some policy violations." Content-language blockers were rewritten in source for `/in-store-strategy`, `/inside-scoop`, and `/faq`; support/legal trust hardening is now also in source (`/support`, `/privacy-policy`, `/terms-of-service`, `/about`, footer/legal IA). Awaiting deployment + refreshed evidence. | Exact policy subsection(s) triggering denial not specified in AdSense UI.                                                                                                                               | `OPEN-CONDITIONAL` (evaluate holdover only after a newly logged review request and wait window) | `2026-02-03` (historical cycle)                     | `2026-02-10` (elapsed for historical cycle) | Deploy rewritten copy + support/legal compliance refactor, refresh evidence snapshots, and make re-review go/no-go call from the updated matrix. | 2026-02-19 | AdSense site status moves to ready/approved, or explicit written policy subtype is resolved and verified by successful re-review.         |
