    ...
    <div className="container mx-auto px-4 sm:px-6 py-8 max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <div className="text-slate-700 dark:text-slate-300 space-y-4 leading-relaxed">
          ...
          <p className="font-medium text-slate-900 dark:text-white">Important for this site:</p>
        ...
        <div className="text-slate-700 dark:text-slate-300 space-y-5 leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-1">
              ...
              <li>Changing the order later through customer service in ways that break tracking</li>
            </ul>
          </div>

          <div>
            <p className="font-medium text-slate-900 dark:text-white mb-1">6. Wait for tracking</p>
            <p>
              Most orders show as &quot;Pending&quot; or &quot;Tracked&quot; in your BeFrugal
              account within a few days, sometimes up to a week.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-1">
              <li>
                Expect roughly 60 to 90 days from purchase until the money is actually available to
                withdraw
              </li>
          ...
          <div>
            <p className="font-medium text-slate-900 dark:text-white mb-1">8. Cash out</p>
            <p>
