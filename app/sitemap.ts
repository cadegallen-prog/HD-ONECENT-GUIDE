...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    // Guide Chapters (High Value Content for AdSense)
    {
      url: `${baseUrl}/guide/inside-scoop`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/guide/digital-pre-hunt`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/guide/in-store-strategy`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/guide/clearance-lifecycle`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/guide/fact-vs-fiction`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/guide/responsible-hunting`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
