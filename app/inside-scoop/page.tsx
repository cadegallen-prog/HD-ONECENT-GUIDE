...
const articleJsonLd = {
  ...
  "@type": "Article",
  headline: "Inside Scoop: Operational Context for Experienced Hunters",
  description:
    "Deeper operational context: disposition paths, handheld tools, policy vs. practice, and advanced 2026 workflow signals.",
  ...
  mainEntityOfPage: "https://www.pennycentral.com/inside-scoop",
}
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Inside Scoop (2026 Context)" },
  ],
}
...
export default function InsideScoopPage() {
  return (
    <>
      ...
      />
      <RouteAdSlots pathname="/inside-scoop" />
      <PageShell width="default" padding="sm" gap="md">
        <div className="w-full max-w-[68ch] mx-auto">
          <nav aria-label="Breadcrumb" className="mb-3 text-sm text-[var(--text-muted)]">
            ...
            <span className="mx-1.5">/</span>
            <span className="text-[var(--text-secondary)]">Inside Scoop (2026 Context)</span>
          </nav>
          <PageHeader
          ...
          <Prose variant="guide">
            ...
            <ul className="mb-8">
              ...
              <li>
                ...
                on the shelf. These locks are automated and cannot be overridden by the associate.
              </li>
            </ul>
            ...
            <ul className="mb-8">
              <li>
                Items marked "No Home" are pre-pull candidates during reset windows. If you see a
            ...
            <ul className="mb-8">
              <li>
                <strong>Verified publicly:</strong> Information that appears in official statements
                or press releases (not penny mechanics).
              </li>
              <li>
              ...
              <li>
                <strong>Speculative:</strong> Plausible theories with no public confirmation. We
                label these clearly.
              </li>
            </ul>
