...
export function EditorialBlock() {
  return (
    <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-[var(--text-secondary)] border-y border-[var(--border-default)] py-4 my-8 not-prose bg-[var(--bg-card)] px-4 rounded-sm">
