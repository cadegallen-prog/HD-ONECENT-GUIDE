  ...
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <section id="digital-tools" className="scroll-mt-24 mt-16">
        ...
        <Alert className="mt-6 bg-blue-50 dark:bg-blue-950/30 border-blue-200">
      ...
      <section id="in-store-hunting" className="scroll-mt-24 mt-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 my-6">
          <div className="bg-orange-50 dark:bg-orange-950/30 p-4 rounded-lg border border-orange-200">
        ...
        <div className="bg-green-50 dark:bg-green-950/30 p-6 rounded-lg border border-green-200 my-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 my-6">
          ...
          <div className="p-4 rounded-lg border bg-red-50 dark:bg-red-950/30 border-red-200">
      ...
      <section id="internal-operations" className="scroll-mt-24 mt-16">
        ...
        <Alert className="my-6 bg-blue-50 dark:bg-blue-950/30 border-blue-200">
          <Info className="h-4 w-4 text-blue-600" />
          <AlertDescription>
      ...
      <section id="conclusion" className="scroll-mt-24 mt-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8">
          ...
          {/* Experienced */}
          <div className="bg-orange-50 dark:bg-orange-950/30 p-6 rounded-lg border border-orange-200">
        ...
        <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg text-center my-8">
